...
class ClientThread extends Thread{
    ...
    public void run(){
        try {
            ...
            String line = null;
            while (!(line = br.readLine()).equals("")) { //빈줄까지 읽어들이면 끝
            ...
            pw.println("name:kim");
            pw.println("email:어쩌구저쩌구");
            pw.println("");
            pw.flush();

            // GET /hello HTTP/1.1의 요청이 왔을 때 /pf.png 대한 파일을 읽어서 출력한다.
            // /hello를 어디서 읽어들이는가 서버 입장으로 봤을 때 어디 경로에 있는 파일을 읽어들일까
            pw.println("<html>"); //바디부분
